...
if __name__ == "__main__":
    ...
    if args.sup_source == 'labels' or args.sup_source == 'keywords':
        x, y, word_counts, vocabulary, vocabulary_inv_list, len_avg, len_std, word_sup_list, perm = \
            load_dataset(args.dataset, model=args.model, sup_source=args.sup_source, with_evaluation=with_evaluation,
    ...
    if args.trained_weights is None:
        ...
        word_sup_array = np.array(
            [np.array([vocabulary[word] for word in word_class_list]) for word_class_list in word_sup_list])
        ...
        wstc.pretrain(x=seed_docs, pretrain_labels=seed_label,
                      ...
                      save_dir='../data_process/data_wstc/results/{}/{}/phase2'.format(args.dataset, args.model))
        ...
        y_pred = wstc.fit(x, y=y, tol=delta, maxiter=args.maxiter, batch_size=args.batch_size,
                          ...
                          save_dir='../data_process/data_wstc/results/{}/{}/phase3'.format(args.dataset, args.model),
    ...
    print("\n### Generating outputs ###")
    write_output('../data_process/data_wstc/' + args.dataset, y_pred, perm)
